    ...
    <div id="main">
      ...
      <div id="Container-Jav">
        <div class="inner-glow-container">
          <img class="avatar-image" src="./_static/img/me.jpg?<?=bin2hex(random_bytes(5));?>" alt="Ảnh tôi">
          <div class="text-container">
       Vũ Xuân Tùng <img class="girl-tick" src="./_static/img/banhradiem.webp?<?=bin2hex(random_bytes(5));?>">
          </div>
        </div>
        ...
        <div class="inner-glow-container">
          <img class="avatar-image" src="./_static/img/mylove.jpeg?<?=bin2hex(random_bytes(5));?>" alt="Ảnh bạn gái tôi">
          <div class="text-container">
     My Love <img class="girl-tick" src="./_static/img/dutvodianh.webp?<?=bin2hex(random_bytes(5));?>">
          </div>
        </div>
      </div>
